...
phobos1 = durchlauf(schritte, h, phi, r, theta, thetadot, epsilon, LM, ktheta)
...
plot(phobos1$theta, phobos1$thetadot,"p", col = "dark blue",xlab=TeX(r'($\theta$)'), ylab = TeX(r'($T d_t \theta  / 2 \pi$)'), sub=TeX(r'($\theta_0 = 0,\,\, \theta'_0 = 0,5,\,\, h=0,0001 $)'))
plot(phobos2$theta, phobos2$thetadot,"p", col = "dark blue",xlab=TeX(r'($\theta$)'), ylab = TeX(r'($T d_t \theta  / 2 \pi$)'), sub=TeX(r'($\theta_0 = 0,\,\, \theta'_0 = 1,\,\, h=0,0001 $)'))
