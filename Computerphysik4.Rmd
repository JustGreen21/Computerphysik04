...
Nach den Keplerschen Gesetzen erhalten wir die Beziehung:
\begin{equation}
...
```{r, echo=FALSE, fig.cap="\\label{fig:grundEntwicklung4} Phobosbewegung für verschiedenste Startrotationen von 1 (rot) bis 1/25 (pink)", fig.width=7,fig.height=4}
library(latex2exp)
