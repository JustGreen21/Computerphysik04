...
In Abb. \ref{fig:grundEntwicklung3} können wir sowohl ein periodisches Verhalten, als auch ein chaotisches Verhalten sehen. Offenkundig haben die Startwerte einen deutlichen Einfluss auf das Verhalten des Mondes. Varieren wir den Startwinkel so finden wir allgemein für Vielfache von $\pi$ ein periodisches Verhalten.
...
Wir können aber sehen, dass dieses Verhalten ein Ausnahmefall ist und wir im Allgemeinen ein chaotisches Verhalten vorfinden.
